...
public class comprarImovel {
    ...
    public static void comprarCasa() {
        ...
        if (localizacao.equalsIgnoreCase("1") && numQuartos == 1) {
            ...
            System.out.println("Parabéns! Trouxemos algumas opções para você na zona industrial da cidade.");
            ...
            System.out.println("Parabéns! Trouxemos algumas opções para você na zona periférica da cidade.");
