...
public class comprarImovel {
    ...
    public static void comprarCasa() {
        ...
        if (localizacao.equalsIgnoreCase("A") && metro && numQuartos == 1 && temGaragem && valorMaximo >= 400000) {
            ...
            System.out.println(
                    "Temos uma casa com 1 quarto, 2 banheiros e 1 vaga para carro localizada em Centro, São Paulo-SP, no valor de R$ 400.000!");
            ...
            // Centro casa 2
        } else if (localizacao.equalsIgnoreCase("A") && metro && numQuartos == 2 && temGaragem
                && valorMaximo >= 500000) {
            System.out.println("Parabéns! Temos uma ótima opções para você no centro da cidade.");
            System.out.println(
                    "Temos uma casa com 2 quartos, 2 banheiros e 2 vagas para carro localizado em Centro, São Paulo-SP, no valor de R$ 500.000! ");
            System.out.println("Deseja prosseguir (s/n)? ");
            ...
            // Centro casa 3
        } else if (localizacao.equalsIgnoreCase("A") && metro && numQuartos == 3 && temGaragem
                && valorMaximo >= 600000) {
            System.out.println("Parabéns! Temos uma ótima opções para você no centro da cidade.");
            System.out.println(
                    "Temos uma casa com 3 quartos, 2 banheiros e 2 vagas para carro localizado em Republica, São Paulo-SP, no valor de R$ 600.000! ");
            System.out.println("Deseja prosseguir (s/n)? ");
            ...
            // Suburbio A
        } else if (localizacao.equalsIgnoreCase("B") && metro && numQuartos >= 1 && temGaragem
                && valorMaximo >= 200000) {
            System.out.println("Encontramos uma bela casa no subúrbio que pode atender às suas necessidades.");
            System.out.println(
                    "Temos uma casa com 1 quartos, 1 banheiros e 1 vagas para carro localizado em Santo Amaro-SP, no valor de R$ 250.000! ");
            System.out.println("Deseja prosseguir (s/n)? ");
            ...
            // suburbio B
        } else if (localizacao.equalsIgnoreCase("B") && metro && numQuartos == 2 && temGaragem
                && valorMaximo >= 280000) {
            System.out.println("Encontramos uma bela casa no subúrbio que pode atender às suas necessidades.");
            System.out.println(
                    "Temos uma casa com 2 quartos, 1 banheiros e 1 vagas para carro localizado em Santo Amaro-SP, no valor de R$ 300.000! ");
            System.out.println("Deseja prosseguir (s/n)? ");
            ...
            // suburbuio C
        } else if (localizacao.equalsIgnoreCase("B") && metro && numQuartos == 3 && temGaragem
                && valorMaximo >= 350000) {
            System.out.println("Encontramos uma bela casa no subúrbio que pode atender às suas necessidades.");
            System.out.println(
                    "Temos uma casa com 3 quartos, 2 banheiros e 1 vagas para carro localizado em Santo Amaro-SP, no valor de R$ 350.000! ");
            System.out.println("Deseja prosseguir (s/n)? ");
            ...
            System.out.println(
                    "Temos uma casa com 1 quartos, 1 banheiros localizado em Grajaú-SP, no valor de R$ 115.000! ");
            System.out.println("Deseja prosseguir (s/n)? ");
            ...
            System.out.println("Há uma casa aconchegante na periferia que pode se encaixar no seu orçamento.");
            System.out.println(
                    "Temos uma casa com 2 quartos, 1 banheiros e 1 vaga para carro, localizado em jardim Gaivotas, no valor de R$ 150.000! ");
            System.out.println("Deseja prosseguir (s/n)? ");
            ...
            System.out.println("Há uma casa aconchegante na periferia que pode se encaixar no seu orçamento.");
            System.out.println(
                    "Temos uma casa com 3 quartos, 2 banheiros e 2 vagas para carro, localizado em Grajaú-SP, no valor de R$ 175.000! ");
            System.out.println("Deseja prosseguir (s/n)? ");
